...
{
    public class LoginRadiusClientEntityBase
    {
        ...
        /// </summary>
        protected LoginRadiusClientEntityBase()
        ...
        private LoginRadiusClientEntityBase(UserRegistrationAuthentication authentication)
        {
